...
// Hardcoded image URL - always the same for this demo
const CAMERA_IMAGE_URL = "/camera.jpg";
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            {/* Item Image - always use hardcoded URL for reliability */}
            <div className="aspect-video bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 flex items-center justify-center">
              {imageError ? (
                <div className="text-center p-8">
                  ...
                  <p className="text-gray-500">Vintage Polaroid Camera</p>
                </div>
              ) : (
                <img
                  src={CAMERA_IMAGE_URL}
                  alt={auction.item?.title || "Vintage Polaroid Camera"}
            ...
            <div className="p-6">
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                {auction.item?.title || "Vintage Polaroid Camera"}
              </h1>
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                {auction.item?.description ||
                  "A beautiful 1970s Polaroid SX-70 Land Camera in excellent condition."}
              </p>
